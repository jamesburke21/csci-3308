...
Object.keys(state_info).forEach(function(key)
{
    ...
    var currentCity = state['capital'];
    var lat = state['lat'];
    var lng = state['lng'];

  	var api_url = 'https://api.forecast.io/forecast/50f0b142006c64da001cb15042c518d0/' + lat + ',' + lng;
    $.ajax({url:api_url, dataType:"jsonp"}).then(function(data) 
    {
            console.log(data)
